        ...
        <main>
            <form id="form1" runat="server" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <!-- drop-down -->
                        <asp:DropDownList ID="ddlNumPeople" runat="server" CssClass="form-control">
                ...
                <div class="form-group">
                    ...
                    <div class="bedtype">
                        <!-- radio buttons -->
                        <asp:RadioButtonList ID="rblBedType" runat="server" CssClass="bedtype" RepeatDirection="Horizontal">
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox ID="txtRequests" runat="server" CssClass="form-control" Rows="4" TextMode="MultiLine"></asp:TextBox>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <!-- drop down -->
                        <asp:DropDownList ID="ddlPreferredContact" runat="server" CssClass="form-control">
